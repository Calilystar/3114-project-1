...
public class SongsTest extends TestCase {
    ...
    public void testResizeTriggered() throws Exception {
        ...
        assertTrue("Artist table should have doubled", 
            result.contains("Artist hash table size doubled"));
            
        
        assertTrue("Song table should have doubled", 
            result.contains("Song hash table size doubled"));
            
        
        assertTrue(result.contains("|Artist C| is added to the Artist database"));
    }
    ...
    public void testInsertNoExpansion() throws Exception {
        ...
        assertFalse("Should not expand pool", 
    ...
    /**
     * forces the expansion to see why we're failing the edge case test in the reference tests.
     * @throws Exception
     */
    public void testForceExpansion() throws Exception {
        ...
        assertTrue("Manager should expand when a block size is requested that is no longer available", 
            result.contains("Memory pool expanded"));
    }
